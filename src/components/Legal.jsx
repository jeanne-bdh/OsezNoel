const Legal = () => {
    return (
        <section className="section-legal d-flex flex-column mx-auto">

            <div className="container-legal">
                <h1 className="text-center py-3">Mentions légales</h1>
                <p>
            ...
            <footer className="container my-3">
                <hr className="w-75 mx-auto text-white border-2 rounded-5">
                    <p className="text-center">&copy; 2024 Osez Noël - Tous droits réservés - <a href="/legalinfos">Mentions légales</a>
                    </p>
            </footer>
            */}
